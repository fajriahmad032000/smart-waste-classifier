                ...
                if model is None:
                    ...
                    **Cara Menyelesaikan:**
                    ...
                    with st.spinner("🤖 AI sedang menganalisis objek menggunakan Model Asli..."):
                        ...
                        # --- SOLUSI REAL-TIME 1: BUAT DICTIONARY DATA BARU ---
                        data_baru = {
                        ...
                        # Kirim ke Firebase Cloud Database Terlebih Dahulu
                        if db is not None:
                            try:
                                ...
                                st.warning(f"Gagal upload ke Firebase: {e}")

                        # --- SOLUSI REAL-TIME 2: PAKSA MASUK KE STATE & REFRESH JALUR CEPAT ---
                        ...
                        # Berikan jeda sebentar agar user melihat balon, lalu paksa halaman sinkronisasi ulang
                        time.sleep(1.5)
                        st.rerun()
