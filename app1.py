            ...
            if st.button("Mulai Analisis AI"):
                if model is None:
                    ...
                    with st.spinner("🤖 AI sedang menganalisis objek..."):
                        ...
                        # 🕒 Ambil waktu presisi detik ini untuk disinkronkan ke Firebase dan lokal
                        ...
                        # 🚨 KORREKSI DI SINI: Hapus atau beri tanda pagar (#) pada st.rerun() 
                        # agar halaman tidak dipaksa refresh dan hasil tetap tampil di layar.
                        # time.sleep(0.5)
                        # st.rerun()
                        
                        # ⚡ Paksa sistem memuat ulang halaman agar data baru langsung masuk ke grafik detik ini juga
                        time.sleep(0.5)
                        st.rerun()
