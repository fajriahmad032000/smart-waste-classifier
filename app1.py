        ...
        if st.session_state.history:
            ...
            with row1_col1:
                ...
                if not df_graph.empty:
                    ...
                    # 🔑 AMAN: Pastikan teks kategori di dataframe selalu huruf kecil agar pas dengan color_map
                    ...
                    warna_sesuai_data = [color_map.get(kat, '#78909c') for kat in df_counts['jenis_sampah']]
                    
                    # Perbaikan px.bar menggunakan color_discrete_sequence agar anti-crash
                    fig_bar = px.bar(
                        df_counts, 
                        x='jenis_sampah', 
                        y='jumlah_log', 
            ...
            with row1_col2:
                ...
                if not df_graph.empty:
                    ...
                    # 🎨 Ambil urutan warna wadah secara dinamis dan aman
                    warna_bin_sesuai_data = [color_map_bin.get(wadah, '#78909c') for wadah in df_bin_counts['warna_tempat_sampah']]
                    
                    # Perbaikan px.bar wadah menggunakan color_discrete_sequence agar anti-crash
                    fig_bin = px.bar(
                        df_bin_counts, 
